...
module.exports = function(req, res, next){
    ...
    var getFilteredProducts = new Promise((resolve, reject) => {
        var connection = manage.createConnection(),
            SQLquery = 'SELECT id, name, short_description, description, price, purchase_price, product_url, img_url, quantity, vendor, category_id, attr_manufacturer, attr_capacity, attr_color, attr_antifreeze_class, provider_num FROM products WHERE ' + condition;
        connection.connect();
