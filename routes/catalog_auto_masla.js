...
module.exports = function(req, res, next){
    ...
    var getProducts = new Promise((resolve, reject) => {
        var connection = manage.createConnection(),
            SQLquery = 'SELECT id, name, short_description, description, price, purchase_price, product_url, img_url, quantity, vendor, category_id, attr_type, attr_manufacturer, attr_vid, attr_sae, attr_capacity, provider_num FROM products WHERE category_id = 1 and quantity > 0';
        connection.connect();
